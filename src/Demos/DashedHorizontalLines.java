...
public class DashedHorizontalLines extends PApplet {
    ScatterPlot plt;
    double[] x;
    double[] y;
    ...
    public void setup() {
        ...
        plt.plotLine(.5, "horizontal").strokeColor("green").strokeWeight(2).style("--").dashLength(100);
    }
    ...
    public static void main(String[] args) {
        PApplet.main("Demos.DashedHorizontalLines");
    }
}
